...
<x-app-layout>
    ...
    <div class="container-xl px-4 mt-n10">
        <form method="POST" action="{{ route('experience.update',$detail->id) }}" class="row justify-content-center" id="formEdit" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="col-lg-8">
                {{-- general card --}}
                <div class="card mb-4">
                    ...
                    <div class="card-body row">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="price" type="text" name="price" value="{{$detail->price}}" />
                        </div>
                        <div class="mb-3">
                            <label for="note" class="form-label">Note</label>
                            <input class="form-control" id="note" type="text" name="note" value="{{$detail->note}}" />
                        </div>
                        <div class="mb-3 col-6">
                            <label for="button_label" class="form-label">Button label</label>
                            <input class="form-control" id="button_label" type="text" name="button_label" value="{{$detail->button_label}}" />
                        </div>
                        <div class="mb-3 col-6">
